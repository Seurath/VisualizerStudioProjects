...
/// <summary>
/// This modifier is used to set float material properties.
/// </summary>
[AddComponentMenu("Visualizer Studio/Modifiers/Material Property Modifier")]
public class VisMaterialPropertyModifier : VisBasePropertyModifier
{	
	#region Defaults Static Class
	
	/// <summary>
    /// This internal class holds all of the defaults of the VisMaterialPropertyModifier class. 
	/// </summary>
    ...
    /// <summary>
    /// This indicates if there was a special target property name entrered for this material property modifier.
